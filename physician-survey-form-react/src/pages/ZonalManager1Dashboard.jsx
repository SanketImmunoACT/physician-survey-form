...
export default function ZonalManager1Dashboard() {
  ...
  const fetchPendingSubmissions = async () => {
    try {
      const response = await api.get("/zm1/submissions"); // Use api.get
  ...
  const handleApprove = async (submissionId) => {
    try {
      const response = await api.put(`/zm1/submissions/${submissionId}/approve`); // Use api.put
  ...
  const handleReject = async (submissionId) => {
    try {
      const response = await api.put(`/zm1/submissions/${submissionId}/reject`); // Use api.put
