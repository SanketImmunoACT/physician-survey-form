...
export default function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // const submissionsResponse = await fetch("http://localhost:5000/api/dashboard/submissions");
      // const submissions = await submissionsResponse.json();

      // Mock data for now
      const stats = {
        totalSurveys: 150,
        monthlyBMTPatients: 1200,
        uniqueFacilities: 45,
        avgPatientsPerFacility: 26,
      };

      const submissions = [
        { id: '1', date: '01/08/2025', salesperson: 'John Doe', physician: 'Dr. Smith', uniqueId: 'PS001', speciality: 'Oncology', hospitalCode: 'HOSP001', visitingHospitals: 3, monthlyPatients: 50, bmtPatients: 10 },
        { id: '2', date: '02/08/2025', salesperson: 'Jane Smith', physician: 'Dr. Jones', uniqueId: 'PS002', speciality: 'Hematology', hospitalCode: 'HOSP002', visitingHospitals: 2, monthlyPatients: 30, bmtPatients: 5 },
        { id: '3', date: '03/08/2025', salesperson: 'John Doe', physician: 'Dr. Brown', uniqueId: 'PS003', speciality: 'Oncology', hospitalCode: 'HOSP003', visitingHospitals: 1, monthlyPatients: 20, bmtPatients: 2 },
      ];
  ...
  useEffect(() => {
    ...
    // These event listeners are for the old client-side data store.
    // In a real application with a backend, you would typically refetch data
    // or use a state management solution that syncs with the backend.
